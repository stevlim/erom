                    ...
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <div class="row form-row">
                                <div class="col-md-12">
                                    <p class="pull-right">
                                        <button type="button" id="btnEdit"  onclick="fnRegistCoInfo();" class="btn btn-danger auth-all">Save</button>
                                        <button type="button" id="btnEditCancel"  onclick="fnClose();"class="btn btn-default">Close</button>
                                    </p>
                                </div>
                            </div>
                        </div>                          
