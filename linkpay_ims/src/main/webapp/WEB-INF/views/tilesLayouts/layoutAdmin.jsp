        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btnAlertModalBottom" class="btn btn-default">Close</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="resetPwdConfirmModal" tabindex="-1" role="dialog" aria-labelledby="modalConfirm" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" onclick="eval(strCallBackFN)();">OKay</button>
                    <button type="button" id="btnResetPwdConfirmModalBottm" class="btn btn-default">Cancel</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="btnPSWDChgModalBottom" class="btn btn-default" data-dismiss="modal" onclick="IONPay.Msg.fnResetBodyClass();">Close</button>
                </div>
            </div>
        </div>
    </div>
