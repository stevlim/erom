...
//    }
    ...
    public static String ConvertDate(DateFormat format, String strType, Object objValue) {
        ...
        if (strValue.length() == 10)  {
            ...
            switch(format) {
                case YYYYMMDD :
                    strRetValue = arrValue[2] + arrValue[1] + arrValue[0]; 
                    break;
                    
                case YYYYMMDDHH24MISS :
                    strRetValue = arrValue[2] + arrValue[1] + arrValue[0] + ("s".equals(strType) ? "000000" : "235959"); 
                    break;
            ...
            switch(format) {
                case YYYYMM :
                    strRetValue = arrValue[1] + arrValue[0]; 
                    break;
                    
                default :
                    strRetValue = arrValue[2] + arrValue[1];
                    break;
            }
        } else {
