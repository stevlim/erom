 ...
 * Modify History : Just Created.
 ------------------------------------------------------------*/
@Controller
@RequestMapping(value="/authorityMgmt/userAccountMgmt")
public class UserAccountMgmtController {
    ...
    public String userAccountMgmt(Model model, CommonMap commonMap) throws Exception {
        ...
        return "/authorityMgmt/userAccountMgmt/userAccountMgmt";
    }
