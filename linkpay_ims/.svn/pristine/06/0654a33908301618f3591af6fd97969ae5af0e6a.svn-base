                              ...
                              <div id="divGridArea" class="grid-body " style="display:none;">
                                     ...
                                     <div class="panel panel-info auth-all">
                                         <div class="panel-heading" style="text-align:right;">
                                             <button id="btnEditMenuGroup" type='button' class='btn btn-danger auth-all'>ALL SAVE</button>
                                         </div>
                                     </div>
                               </div> 
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="pull-right">
                         <button type="button" id="btnEditMenu" class="btn btn-danger">Save</button>
