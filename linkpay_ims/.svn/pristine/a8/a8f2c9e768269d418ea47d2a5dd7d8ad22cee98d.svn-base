    ...
    if (typeof objFaqMgmtListDT == "undefined") {
    	objFaqMgmtListDT = IONPay.Ajax.CreateDataTable("#tbFaqMgmtList", true, {
            ...
            columns: [                
                ...
                { "class" : "columnl all text-center",  "data" : null, "render": function(data, type, full, meta){return "<a href='javascript:fnSelectFaqMgmt("+ data.SEQ_NO +");'><span class='text-info'>"+ data.TITLE +"</span></a>";} },
...
function fnSelectFaqMgmtRet(objJson) {
    if (objJson.resultCode == 0) {
        ...
        $("#TITLE").val(objJson.rowData.TITLE);
...
<!--                                 </div>                                 -->
                            ...
                            <div class="grid-body no-border">
                                <div class="row form-row">
                                    <div class="col-md-12">
                                        <p class="pull-right">
                                            <button type="button" id="btnEdit" class="btn btn-danger auth-all">Save</button>
