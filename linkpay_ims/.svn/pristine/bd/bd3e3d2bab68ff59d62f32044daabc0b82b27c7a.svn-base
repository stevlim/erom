...
public class CommonDDLB {
    ...
    public static String merchantType3_1() {
    	...
    	objSb.append(makeOption("2", CommonMessageDic.getMessage("DDLB_0137")));
    	objSb.append(makeOption("3", CommonMessageDic.getMessage("DDLB_0138")));
    	objSb.append(makeOption("4", CommonMessageDic.getMessage("DDLB_0139")));
    	objSb.append(makeOption("1", CommonMessageDic.getMessage("IMS_BIM_MM_0054")));
    	objSb.append(makeOption("5", CommonMessageDic.getMessage("IMS_BM_CM_0012")));
    ...
    public static String merchantType5() {
    	...
    	objSb.append(makeOption("2", CommonMessageDic.getMessage("DDLB_0137"), true));
    	objSb.append(makeOption("3", CommonMessageDic.getMessage("DDLB_0138")));
    	objSb.append(makeOption("4", CommonMessageDic.getMessage("DDLB_0139")));
    	objSb.append(makeOption("1", CommonMessageDic.getMessage("IMS_BIM_MM_0054")));
    ...
    public static String merchantType6() {
    	...
    	objSb.append(makeOption("0", CommonMessageDic.getMessage("DDLB_0137")));
    	objSb.append(makeOption("1", CommonMessageDic.getMessage("DDLB_0138")));
    	objSb.append(makeOption("2", CommonMessageDic.getMessage("DDLB_0139")));
...
//	   	setDDLBType(objSb, ddlbType);
 ...
 //답변상태
   public static String askStatus(DDLBType ddlbType) {
       ...
       objSb.append(makeOption("02", CommonMessageDic.getMessage("IMS_BM_IM_0009")));
       objSb.append(makeOption("03", CommonMessageDic.getMessage("IMS_BM_IM_0010")));
