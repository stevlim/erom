...
function fnGetMenuList(){
	...
	menuList.forEach(function(val, index){
		if(val.DEPTH == 1 || val.STATUS == "0"){
			...
			// 권한 > Admin
			if(val.MENU_GRP_NO == 15){
			//if(val.MENU_GRP_NO == 1){
			if(val.MENU_LINK != "#"){
			...
			// 정산
			//else if(val.MENU_GRP_NO == 11) {
			else if(val.MENU_GRP_NO == 8) {	
				if(val.MENU_LINK != "#"){
	...
	menuList.forEach(function(val, index){
		if(val.DEPTH == 3 && val.STATUS == "1"){
			...
			// 권한 > Admin
			if(val.MENU_GRP_NO == 15){//if(val.MENU_GRP_NO == 1){
			...
			if(nextMenu != undefined){
				if((nextMenu.PARENT_MENU_NO == 0 && val.MENU_GRP_NO == 15) || (nextMenu.MENU_NO == 0 && val.MENU_GRP_NO == 15)){
				//if((nextMenu.PARENT_MENU_NO == 0 && val.MENU_GRP_NO == 1) || (nextMenu.MENU_NO == 0 && val.MENU_GRP_NO == 1)){	
					depth3DOM.html(authorityMgmtDepth3HTML);
					authorityMgmtDepth3HTML = "";
				//}else if((nextMenu.PARENT_MENU_NO == 0 && val.MENU_GRP_NO == 11) || (nextMenu.MENU_NO == 0 && val.MENU_GRP_NO == 11)){
				}else if((nextMenu.PARENT_MENU_NO == 0 && val.MENU_GRP_NO == 8) || (nextMenu.MENU_NO == 0 && val.MENU_GRP_NO == 8)){	
					depth3DOM.html(calcuMgmtDepth3HTML);
					calcuMgmtDepth3HTML = "";
				}else if((nextMenu.PARENT_MENU_NO == 0 && val.MENU_GRP_NO == 13) || (nextMenu.MENU_NO == 0 && val.MENU_GRP_NO == 13)){
					depth3DOM.html(operMgmtDepth3HTML);
					operMgmtDepth3HTML = "";
				}else if((nextMenu.PARENT_MENU_NO == 0 && val.MENU_GRP_NO == 4) || (nextMenu.MENU_NO == 0 && val.MENU_GRP_NO == 4)){
					depth3DOM.html(businessMgmtDepth3HTML);
					businessMgmtDepth3HTML = "";
				}else if((nextMenu.PARENT_MENU_NO == 0 && val.MENU_GRP_NO == 7) || (nextMenu.MENU_NO == 0 && val.MENU_GRP_NO == 7)){
					depth3DOM.html(paymentMgmtDepth3HTML);
					paymentMgmtDepth3HTML = "";
				}else if((nextMenu.PARENT_MENU_NO == 0 && val.MENU_GRP_NO == 6) || (nextMenu.MENU_NO == 0 && val.MENU_GRP_NO == 6)){
					depth3DOM.html(baseinfoMgmtDepth3HTML);
					baseinfoMgmtDepth3HTML = "";
				}else if((nextMenu.PARENT_MENU_NO == 0 && val.MENU_GRP_NO == 9) || (nextMenu.MENU_NO == 0 && val.MENU_GRP_NO == 9)){
				...
				// 12 > 11
					...
					totalMgmtDepth3HTML = "";
				}/* else if((nextMenu.PARENT_MENU_NO == 0 && val.MENU_GRP_NO == 5) || (nextMenu.MENU_NO == 0 && val.MENU_GRP_NO == 5)){
            ...
            <form id="frmpw">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="btnChangePW" class="btn btn-danger">Save</button>
                        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="IONPay.Msg.fnResetBodyClass(); IONPay.Utils.fnFrmReset('frmpw');">Cancel</button>
                    </div>
                </div>
            </form>
            </div>
